...
``easyqda-fragments-demo.csv`` and ``easyqda-history-demo.csv`` are a genuine
zotQDA export, generated by the plugin's own export code via
``tool/gen-demo-study.js`` in the zotQDA repository.  These tests freeze the
...
@pytest.mark.parametrize("name", ["easyqda-fragments-demo.csv",
